...
export const projects: Projects = [
  ...
  },
  {
    ...
    description: {
      ...
      full:
        "<p>I initally started this set of projects with the counter app because it seemed the quickest and easiest way to try out Vite (and it's always useful to have a counter app to call on 😎).</p><p>From there I developed two more apps, <code><a class='link' href='https://github.com/rga-king/social-climber-app' target='_blank' rel='noopener noreferrer'>social-climber-app</a></code> and <code><a class='link' href='https://github.com/rga-king/good2go-app' target='_blank' rel='noopener noreferrer'>good2go-app</a></code>.</p><p><code><a class='link' href='https://github.com/rga-king/social-climber-app' target='_blank' rel='noopener noreferrer'>social-climber-app</a></code> is a word analytics tool that helps a user create a social media post that could be used across multiple platforms. It provides real-time analytics on the word count set against the word limit for each platform. I have a number of ideas on how to take this forward and give it more real-world applications, particularly partnering it up with AI to provide support on the post content itself.</p><p><code><a class='link' href='https://github.com/rga-king/good2go-app' target='_blank' rel='noopener noreferrer'>good2go-app</a></code> is an alternative take on the todo list app. It enables the user to create a list of items they want to pack for a trip, and keep track of what they have packed. It makes use of Zustand's state management and persistence features to manage the user's data.</p>"
    },
    toolkit: [
      toolkit.javascript,
      toolkit.typescript,
