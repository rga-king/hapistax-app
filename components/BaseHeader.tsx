...
export default function BaseHeader() {
  return (
    <header className={styles.header}>
      ...
      <Link href="bbc.co.uk"><Image src={linkedIn} width="40" height="32" alt="" /></Link>
      {/* <Link href="bbc.co.uk"><Image src={linkedIn} width="131" height="32" alt="" /></Link> */}
      <span className={styles.divider}>/</span>
      <Link href="bbc.co.uk" className={styles.link}>Testimonials</Link>
      <span className={styles.divider}>/</span>
      <Link href="bbc.co.uk" className={styles.link}>Curriculum Vitae</Link>
      <span className={styles.divider}>/</span>
      <Link href="bbc.co.uk" className={styles.link}>Bio</Link>
    </header>
  );
}